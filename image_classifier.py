...
class ImageClassifier(object):
	...
	def __init__(self):
		...
		# self.name = 'ResNet50_Nodule'
		#self.name = 'ResNet50_Pnuemonia'
		#self.name = 'ResNet50_PleuralThickening'
		# self.name = 'ResNet50_Pneumothorax'
		# self.name = 'ResNet50_hernia'
	...
	def pretrained_model(self):
		...
		base_model = DenseNet169(include_top=False,input_shape=self.input_shape,weights='imagenet')
	...
	def train(self,lr=2,num_epochs=2):
	...
	def get_metrics(self,save_logs=True):
		...
		if save_logs:
			...
			print(cm, end="", file=file)
			print(report, end="", file=file)
			file.close()
...
if __name__ == '__main__':
	...
	clf = ImageClassifier()
	clf.train(lr=1e-5,num_epochs=5)
	del clf

	# clf = ImageClassifier()
	# clf.continue_training(lr=1e-5,num_epochs=50)
	# del clf
